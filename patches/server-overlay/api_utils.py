...
def log_non_default_args(args: Namespace | EngineArgs):
    # P1-2: 日志脱敏 (对齐上游 PR#89 redacted, 2026-08-24) — 防密钥明文落入 docker logs
    _REDACTED_KEYS = ("api_key", "hf_token", "dspark_api_keys")
    non_default_args = get_non_default_args(args)
    for _k in _REDACTED_KEYS:
        if _k in non_default_args:
            non_default_args[_k] = "<redacted>"
