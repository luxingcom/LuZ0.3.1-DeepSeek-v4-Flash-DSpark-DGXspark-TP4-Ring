...
| 18 | <MGMT_OCTET> | <INSTALL_DIR>/scripts/start_head_v026r.sh | ~/start_head_v026r.sh | head 启动 v3.3 加固（GID_INDEX=2） | ✅ |
...
| `ibv_modify_qp failed 61` | <MGMT_OCTET> 重启后 GID3 空 | NCCL_IB_GID_INDEX=2（脚本已固定） |
